package com.android.terminalbox.widget;
...
public class FaceSearchResultAdapter extends RecyclerView.Adapter<FaceSearchResultAdapter.CompareResultHolder> {
    ...
    @Override
    public CompareResultHolder onCreateViewHolder( ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder( CompareResultHolder holder, int position) {
    ...
    class CompareResultHolder extends RecyclerView.ViewHolder {
        ...
        CompareResultHolder( View itemView) {
            super(itemView);
        }
    }
}
