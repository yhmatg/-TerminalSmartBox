package com.android.terminalbox.faceserver;//package com.rylai.smartbox.faceserver;
//
...
//import com.rylai.smartbox.model.FaceRegisterInfo;
//
//import java.io.File;
...
//
//    public static FaceServerbak getInstance() {
//        if (faceServer == null) {
//            synchronized (FaceServerbak.class) {
//                if (faceServer == null) {
//                    faceServer = new FaceServerbak();
//                }
//            }
//        }
//        return faceServer;
