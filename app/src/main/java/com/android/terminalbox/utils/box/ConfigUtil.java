...
public class ConfigUtil {
    ...
    public static DetectFaceOrientPriority getFtOrient(Context context) {
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences(APP_NAME, Context.MODE_PRIVATE);
        String asp = sharedPreferences.getString(FT_ORIENT, DetectFaceOrientPriority.ASF_OP_270_ONLY.name());
        Log.d(TAG, "getFtOrient: "+asp);
        return DetectFaceOrientPriority.valueOf(asp);
    }
}
